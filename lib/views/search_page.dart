...
class KvnScrollViewSearch extends StatefulWidget {
  const KvnScrollViewSearch({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _KvnScrollViewSearch();
}

class _KvnScrollViewSearch extends State<KvnScrollViewSearch> {
  var cards = <Widget>[];
